...
";
        ...
        [Fact]
        public void CanSerializeImmutableMessagesWithAutoProperty()
        {
            var message = new ImmutableMessageAutoProp(("aaa", "bbb"));
            AssertEqual(message);
        }
        ...
        [Fact]
        public void CanSerializeImmutableMessagesWithPrivateCtorWithAutoProperty()
        {
            var message = new ImmutableMessageWithPrivateCtorAutoProp(("aaa", "bbb"));
            AssertEqual(message);
        }
...
my-settings{
    ...
    c: 3
        ...
        public void CanSerializeSupervisor()
        {
            ...
            Assert.NotNull(sRef);
            var sDecider = (DeployableDecider) sRef.Decider;
